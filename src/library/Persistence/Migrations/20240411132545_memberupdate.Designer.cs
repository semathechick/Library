...
namespace Persistence.Migrations
{
    ...
    [Migration("20240411132545_memberupdate")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c77acf58-d939-4484-a657-141669ee9ccf"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            PasswordHash = new byte[] { 17, 238, 12, 98, 10, 250, 150, 126, 137, 67, 181, 217, 221, 164, 110, 254, 187, 234, 108, 206, 127, 212, 181, 16, 10, 244, 168, 135, 229, 62, 0, 141, 39, 6, 48, 248, 156, 14, 183, 67, 58, 183, 90, 150, 66, 246, 40, 235, 182, 219, 92, 242, 19, 120, 180, 12, 80, 77, 55, 20, 37, 60, 62, 183 },
                            PasswordSalt = new byte[] { 148, 254, 34, 41, 60, 213, 140, 206, 159, 216, 202, 197, 197, 147, 19, 66, 116, 71, 75, 224, 247, 112, 164, 214, 242, 75, 130, 106, 242, 101, 160, 163, 233, 200, 231, 8, 99, 160, 211, 236, 122, 205, 11, 110, 118, 252, 229, 77, 139, 74, 99, 100, 130, 199, 159, 109, 191, 155, 237, 244, 120, 64, 183, 170, 187, 38, 214, 65, 161, 100, 158, 32, 90, 156, 56, 6, 103, 105, 111, 37, 39, 1, 196, 57, 241, 109, 42, 163, 246, 188, 117, 153, 204, 233, 221, 191, 112, 200, 21, 226, 209, 156, 105, 125, 253, 219, 104, 65, 41, 75, 95, 222, 134, 201, 161, 100, 254, 176, 191, 54, 247, 117, 123, 194, 137, 10, 63, 170 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4674ea2a-0d72-41f3-a552-ca9b0e9556af"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("c77acf58-d939-4484-a657-141669ee9ccf")
                        });
                });
